...
public final class CameraConfigurationUtils {
    ...
    private static final float TARGET = 100.0f;
    ...
    public static void setBestPreviewFPS(Camera.Parameters parameters, int minFPS, int maxFPS) {
        ...
        if (supportedPreviewFpsRanges != null && !supportedPreviewFpsRanges.isEmpty()) {
            ...
            for (int[] fpsRange : supportedPreviewFpsRanges) {
                ...
                if (thisMin >= minFPS * NUM_1000 && thisMax <= maxFPS * NUM_1000) {
    ...
    private static Integer indexOfClosestZoom(Camera.Parameters parameters, double targetZoomRatio) {
        ...
        double target100 = TARGET * targetZoomRatio;
        ...
        Log.i(TAG, "Chose zoom ratio of " + (ratios.get(closestIndex) / TARGET));
        return closestIndex;
    }
    ...
    public static String collectStats(CharSequence flattenedParams) {
        StringBuilder result = new StringBuilder(NUM_1000);
