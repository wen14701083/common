...
import com.xhd.base.zxing.camera.open.OpenCameraInterface;
...
public final class CameraManager {
    ...
    /**
     * Convenience method for {@link com.xhd.base.zxing.CaptureActivity}
     *
    ...
    private static int findDesiredDimensionInRange(int resolution, int hardMin, int hardMax) {
        ...
        int dim = NUM_5 * resolution / NUM_8;
        if (dim < hardMin) {
            return hardMin;
        }
    ...
    public void openLight() {
        if (camera != null && camera.getCamera() != null) {
            ...
            if (parameters != null) {
                ...
                ToastUtils.INSTANCE.toast("相机打开闪光灯出错");
            }
        }
    ...
    public void offLight() {
        ...
        if (params != null) {
            ...
            ToastUtils.INSTANCE.toast("相机关闭闪光灯出错");
        }
    }
}
